...
export const sendNodemailer = () => (req: Request, res: Response, next: NextFunction) => {
    ...
    const newTransport = nodemailer.createTransport({
        ...
        auth: {
            user: 'nodevalidation12@gmail.com', // Email que vai ENVIAR um email !! <<
    ...
    newTransport.sendMail({
        from: 'Node Validation <nodevalidation12@gmail.com>', // Nome do Email (ACHO QUE É OPCIONAL) + <Email> (Se NÃO tiver o Nome do Email, pode colocar o Email DIRETO sem os <> ) !! <<
